# BẢNG TỔNG HỢP BACKLOG DỰ ÁN MEDICORE
...
| **MC-06** | Đặt lịch khám trực tuyến (Tự động gán bác sĩ và Giới hạn lịch chờ). |
| **MC-07** | Thiết lập Gateway WebSocket truyền tin và thông báo thời gian thực. |
| **MC-08** | Quản lý Hàng chờ khám Real-time và Điều phối ca khám cho Bác sĩ. |
| **MC-09** | Thực hiện quy trình Khám bệnh, Chẩn đoán lâm sàng và Lưu hồ sơ EMR. |
| **MC-10** | Kê đơn thuốc điện tử và Tự động xuất bản đơn thuốc định dạng PDF. |
| **MC-11** | Cổng thông tin Bệnh nhân: Xem Timeline lịch sử và Tải hồ sơ cá nhân. |
| **MC-12** | Trợ lý AI Bệnh nhân: Phân tích triệu chứng và Gợi ý chuyên khoa phù hợp. |
